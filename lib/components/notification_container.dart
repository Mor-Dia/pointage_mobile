...
class NotificationContainer extends StatefulWidget {
  ...
  const NotificationContainer({super.key, required this.notificationPush, this.updateFunction, this.enableOnTap = true});
          ...
          if(enableOnTap){
            if(notificationPush.dataType == "pratique"){
              if(notificationPush.dataId != null){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => PratiqueDetail(pratiqueId: pratiqueId)));
              }
            } else if(notificationPush.dataType == "reservation"){
              if(notificationPush.dataId != null){
                int? reservationId = notificationPush.dataId;
                Navigator.push(context, MaterialPageRoute(builder: (context) => ReservationDetail(reservationId: reservationId)));
              }
            }
          }
        },
