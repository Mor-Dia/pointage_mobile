        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: const TabBarView(
              children: [
                NotificationPushList(basedFilter: {"is_read": false},),
                NotificationPushList(basedFilter: {"is_read": true},)
              ],
            ),
          ),
        )
...
class _NotificationPushListState extends State<NotificationPushList> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    ...
    if(widget.basedFilter != null){
      ...
      if(widget.basedFilter!.containsKey("is_read") && !widget.basedFilter!["is_read"]){
        isUnReadList = true;
      }
    }
  ...
  markAllAsRead(Map<String, dynamic> params){
    postApiBloc.add(PostApiMakeCall(endpoint: 'markallasread', parameters: params));
  }
                                  ...
                                  child: BlocConsumer(
                                    ...
                                    listener: (context, state) {
                                      if (state is PostApiSuccess) {
                                        updateList({...currentFilter, ...{"client_id": currentUserId}});
                                      }
